...
export function getPlaceholderText(isLoading: boolean, hasError: boolean): string {
  if (isLoading) { return "Loading..."; }
  if (hasError) { return "Failed to load types"; }
              ...
              <FormControl>
                <Combobox
                  ...
                  onValueChange={(value) => {
                    ...
                    form.setValue('coverageType', '', { shouldValidate: false });
