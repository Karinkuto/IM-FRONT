      ...
      <div className="flex items-center">
        {ratingItems.map(({ key, filled, fillPercentage }) => (
          <div key={key} className="relative">
            ...
            <Icon className={cn(sizeClasses[size], inactiveColor, "transition-colors duration-200")} />
            ...
            {filled && (
              ...
              >
                <Icon
                  className={cn(sizeClasses[size], activeColor, "transition-colors duration-200")}
                  fill="currentColor"
                />
              </div>
            )}
